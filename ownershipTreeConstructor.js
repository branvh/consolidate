const fs = require('fs');
const OWNERSHIP_FILE = 'ownershipData.csv';
const SNL_TREE_DATA = 'currentSNLTree.csv';
const BANK_DATA_IMPORT_FILE = 'bankDataImport.csv'
const FILTERED_COMPANY_FILE = 'listOfSNLIDsForDataImport.csv';  //this is currently used as an output file

const ownershipConstructor = require('./bankOwnershipStructureObjectConstructor.js');
const treeConstructor = require('./treeConstructor.js');
